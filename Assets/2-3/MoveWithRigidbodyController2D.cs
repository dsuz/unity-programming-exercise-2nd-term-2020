...
public class MoveWithRigidbodyController2D : MonoBehaviour
{
    ...
    /// <summary>
    /// 前方に壁を検出するまで右に移動し、壁を検出したら停止する処理を書け。
    /// </summary>
    void Exercise17()
    {
    ...
    /// <summary>
    /// 床を検出している間は右移動し、床がないことを検出したら停止する処理を書け。
    /// </summary>
    void Exercise19()
    {
        Vector2 origin = this.transform.position;
    ...
    /// <summary>
    /// 前方に床を検出している間は右移動し、床がないことを検出したら方向転換して左に移動する処理を書け。
    ...
    /// <summary>
    /// 前方に壁を検出した時と前方に床がないことを検出した時に方向転換する処理を書け。
    /// </summary>
    void Exercise21()
    {
